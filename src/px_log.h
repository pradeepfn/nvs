...
typedef struct checkpoint_t_{
    ...
    offset_t start_offset;  // start offset in linear log
    offset_t end_offset;   // end offset in linear log
}checkpoint_t;
...
typedef struct ringbuffer_t_{
    ...
    offset_t log_head; // head offset of the linear log, caching purposes
    offset_t log_tail; // tail offset of the linear log, caching purposes
}ringbuffer_t;
