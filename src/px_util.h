...
int nvmmemcpy_dedupv(void *dest_ptr,void *var_ptr,long var_size,int *dvector, long dv_size, int nvram_bw);
int nvmmemcpy_dedup_apply(void *ret_ptr,long size, void *var_ptr,long var_size,int *dvector,long dv_size);
