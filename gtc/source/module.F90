...
module global_parameters
  ...
  !mjc changed following to *8
  integer rng_control,mype ! mjc put this here to avoid conflict
  integer*8 mi,mimax,me,me1,memax,mgrid,mpsi,mthetamax,mzeta,mzetamax,&
       istep,ndiag,ntracer,msnap,mstep,mstepall,stdout,numberpe,&
       mode00,nbound,irun,iload,irk,idiag,ncycle,mtdiag,idiag1,idiag2,&
       ntracer1,nhybrid,ihybrid,nparam,limit_vpara,fixed_Tprofile
